...
float posX = 0, posY = 2.5, posZ = -3.5, rotRodIzq = 0, giroBrazoIzq = 0, rotRodDer = 0, giroBrazoDer = 0, giroPieDer = 0, giroPieIzq = 0; float giroMonito = 0;
...
typedef struct _frame
{
	...
	float giroMonito;
	float giroMonitoInc;
	float giroBrazoIzq;// VALOR INICIAL
	float giroBrazoIzqInc;//VALOR INCREMENTO
	float giroBrazoDer;// VALOR INICIAL
	float giroBrazoDerInc;//VALOR INCREMENTO
	float giroPieIzq;// VALOR INICIAL
	float giroPieIzqInc;//VALOR INCREMENTO
	float giroPieDer;// VALOR INICIAL
	float giroPieDerInc;//VALOR INCREMENTO
...
void monito()
{
	...
	glRotatef(-45 + giroBrazoDer, 0, 1, 0);
	...
	glPushMatrix();
	glTranslatef(-0.25, 0, 0);
	glRotatef(45 + giroBrazoIzq, 0, 1, 0);
	glRotatef(25, 0, 0, 1);
	glRotatef(25, 1, 0, 0);
	glTranslatef(-0.75, 0, 0);
	fig7.prisma(0.7, 1.5, 0.7, 0);
...
void InitGL(GLvoid)     // Inicializamos parametros
{
	...
	KeyFrame[0].posY = 0;
	KeyFrame[0].posZ = 2.5;
	KeyFrame[0].rotRodIzq = -9.0;
	KeyFrame[0].rotRodDer = -15.0;
	KeyFrame[0].giroMonito = 0.0;
	KeyFrame[0].giroPieDer = -60.0;
	KeyFrame[0].giroPieIzq = 2.0;
	KeyFrame[0].giroBrazoDer = -115.0;
	KeyFrame[0].giroBrazoIzq = 96.0;

	KeyFrame[1].posX = -3.5;
	KeyFrame[1].posY = 0;
	KeyFrame[1].posZ = 2.5;
	KeyFrame[1].rotRodIzq = -16.0;
	KeyFrame[1].rotRodDer = -9.0;
	KeyFrame[1].giroMonito = 0.0;
	KeyFrame[1].giroPieDer = 12.0;
	KeyFrame[1].giroPieIzq = -78.0;
	KeyFrame[1].giroBrazoDer = -115.0;
	KeyFrame[1].giroBrazoIzq = 96.0;

	KeyFrame[2].posX = -3.5;
	KeyFrame[2].posY = 0;
	KeyFrame[2].posZ = 2.5;
	KeyFrame[2].rotRodIzq = -5.0;
	KeyFrame[2].rotRodDer = -9.0;
	KeyFrame[2].giroMonito = 0.0;
	KeyFrame[2].giroPieDer = 13.0;
	KeyFrame[2].giroPieIzq = -1.0;
	KeyFrame[2].giroBrazoDer = -115.0;
	KeyFrame[2].giroBrazoIzq = 96.0;

	KeyFrame[3].posX = -3.5;
	KeyFrame[3].posY = 0;
	KeyFrame[3].posZ = 2.5;
	KeyFrame[3].rotRodIzq = -5.0;
	KeyFrame[3].rotRodDer = -9.0;
	KeyFrame[3].giroMonito = 0.0;
	KeyFrame[3].giroPieDer = -33.0;
	KeyFrame[3].giroPieIzq = -41.0;
	KeyFrame[3].giroBrazoDer = 12.0;
	KeyFrame[3].giroBrazoIzq = -6.0;

	KeyFrame[4].posX = -3.5;
	KeyFrame[4].posY = 0;
	KeyFrame[4].posZ = 2.5;
	KeyFrame[4].rotRodIzq = 53.0;
	KeyFrame[4].rotRodDer = 47.0;
	KeyFrame[4].giroMonito = 0.0;
	KeyFrame[4].giroPieDer = -32.0;
	KeyFrame[4].giroPieIzq = -41.0;
	KeyFrame[4].giroBrazoDer = 12.0;
	KeyFrame[4].giroBrazoIzq = -6.0;

	KeyFrame[5].posX = -3.5;
	KeyFrame[5].posY = 0;
	KeyFrame[5].posZ = 2.5;
	KeyFrame[5].rotRodIzq = 53.0;
	KeyFrame[5].rotRodDer = 47.0;
	KeyFrame[5].giroMonito = 181.0;
	KeyFrame[5].giroPieDer = -31.0;
	KeyFrame[5].giroPieIzq = -41.0;
	KeyFrame[5].giroBrazoDer = 12.0;
	KeyFrame[5].giroBrazoIzq = -6.0;

	KeyFrame[6].posX = -3.5;
	KeyFrame[6].posY = 0;
	KeyFrame[6].posZ = 2.5;
	KeyFrame[6].rotRodIzq = 53.0;
	KeyFrame[6].rotRodDer = 47.0;
	KeyFrame[6].giroMonito = 362.0;
	KeyFrame[6].giroPieDer = -30.0;
	KeyFrame[6].giroPieIzq = -41.0;
	KeyFrame[6].giroBrazoDer = 12.0;
	KeyFrame[6].giroBrazoIzq = -6.0;
	//////////////////////////////////////////////////////////////////////////////////
