...
void InitGL ( GLvoid )										// Inicializamos parametros
{
	...
	t_puerta01.LoadBMP("puerta.bmp");
	t_puerta01.BuildGLTexture();
	t_puerta01.ReleaseImage();

	t_ventana01.LoadBMP("ventana.bmp");
...
// CASA
		// PARED TRASERA
		glPushMatrix();
			glScalef(4.1, 8.0, 0.1);
			prisma(0, t_cemento01.GLindex, t_tabique01.GLindex, t_cemento01.GLindex, 0, 0);
		glPopMatrix();
		...
		glPushMatrix();
			...
			prisma2(0, 0, t_ventana01.GLindex, 0, 0, 0);
		glPopMatrix();
		...
		glPushMatrix();
			...
			prisma2(0, 0, t_puerta01.GLindex, 0, 0, 0);
		glPopMatrix();
/*
//SILLA
		glPushMatrix();
			glTranslatef(4.0, 0.0, 0.0);
			glScalef(2.0, 5.0, 1.0);
			prisma(0, 0);
		glPopMatrix();
//AJEDREZ
		glPushMatrix(); 
